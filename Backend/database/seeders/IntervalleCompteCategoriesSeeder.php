...
class IntervalleCompteCategoriesSeeder extends Seeder
{
    public function run()
    {
        $datas = [
            ...
            ['compte_debut' => '730', 'compte_fin' => '739', 'code_cat' => 'PRODFIN'],       // Produits financiers
            ...
            ['compte_debut' => '620', 'compte_fin' => '629', 'code_cat' => 'CHPERS'],        // Charges de personnel
            ['compte_debut' => '630', 'compte_fin' => '639', 'code_cat' => 'IMPTAX'],        // Impôts et taxes
            ['compte_debut' => '640', 'compte_fin' => '649', 'code_cat' => 'AMORTPROV'],     // Dotations aux amortissements/provisions
            ['compte_debut' => '650', 'compte_fin' => '659', 'code_cat' => 'CHARGEFIN'],     // Charges financières
            ...
            ['compte_debut' => '400', 'compte_fin' => '409', 'code_cat' => 'CLIENTS'],       // Clients
            ...
            ['compte_debut' => '120', 'compte_fin' => '129', 'code_cat' => 'PRIME'],         // Primes/Réserves
